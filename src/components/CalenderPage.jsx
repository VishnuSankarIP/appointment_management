...
// //   const [selectedSlot, setSelectedSlot] = useState(moment().startOf('day').toDate());
...
//     if (selectedSlot) {
//       const newDate = moment(selectedSlot).add(direction, 'days').toDate();
...
//             <input
//               type="date"
//               value={selectedSlot ? moment(selectedSlot).format('YYYY-MM-DD') : moment().format('YYYY-MM-DD')}
...
//                   const doctor = doctors.find((d) => d.id === parseInt(appt.doctorId));
//                   return (
//                     <div key={appt.id} className="bg-white p-4 rounded-lg shadow border">
//                       <div className="flex justify-between items-center">
//                         <div>
//                           <p className="font-semibold text-gray-800">👤 {patient?.name}</p>
//                           <p className="text-gray-600">🩺 {doctor?.name}</p>
//                           <p className="text-gray-600">
//                             🕒 {moment(appt.time, 'HH:mm').format('h:mm A')}
//                           </p>
//                         </div>
...
//     });
//     const [showForm, setShowForm] = useState(false);
//     // Initialize selectedSlot to null to prevent modal from opening on refresh
...
//         // Check for duplicate doctor time slot
...
//             : moment().add(direction, 'days').toDate(); // Fallback to current date if selectedSlot is null
//         setSelectedSlot(newDate);
//     };
...
//     // Format selectedSlot for consistent comparison
//     const formattedSelectedSlot = selectedSlot
//         ? moment(selectedSlot).format('YYYY-MM-DD')
//         : moment().format('YYYY-MM-DD'); // Default to current date in mobile view
...
//                                     </button>
//                                 </div>
//                                 {appointments.filter((appt) => appt.date === formattedSelectedSlot).length === 0 ? (
//                                     <p className="text-gray-500">No appointments found.</p>
//                                 ) : (
//                                     appointments
...
//             {showForm && (
//                 <AppointmentForm
//                     date={selectedSlot || new Date()} // Fallback to current date if selectedSlot is null
//                     initialData={editAppointment}
//                     onClose={() => {
//                         setShowForm(false);
//                         setEditAppointment(null);
